...
const Container = ({ children, tailwindStyles = '' }: ContainerProps) => {
  ...
  return (
    ...
    >
      <div
        className={`container-div w-full h-full p-1 bg-gray shadow-normal border-2 border-t-white border-l-white text-black cursor-auto sm:w-[525px] ${tailwindStyles}`}
      >
        {children}
      </div>
    </div>
