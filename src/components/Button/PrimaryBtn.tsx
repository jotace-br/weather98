...
const PrimaryBtn = ({
  ...
  return (
    <button
      className={`w-full h-[30px] sm:w-[30%] text-[0.6875rem] gap-1 p-1 bg-gray flex justify-center place-items-center shadow-normal border-[1px] border-b-black border-r-black  border-t-white border-l-white ${tailwindStyles} ${
        isDisabled
